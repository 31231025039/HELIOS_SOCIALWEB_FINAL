# HELIOS Web - Website mạng xã hội hỗ trợ tìm việc làm
## Thông tin học phần
- Học phần: Phát triển Ứng dụng Web
- Đề tài: Thiết kế và triển khai Website mạng xã hội - Helios

## Giới thiệu
Trong bối cảnh chuyển đổi số và nhu cầu kết nối nghề nghiệp ngày càng tăng, việc xây dựng một nền tảng mạng xã hội hỗ trợ tìm kiếm việc làm và phát triển cộng đồng trở nên cần thiết. Đề tài này xây dựng một website mạng xã hội nghề nghiệp giúp người dùng dễ dàng tạo hồ sơ cá nhân, kết nối với cộng đồng, chia sẻ bài viết, tìm kiếm việc làm và ứng tuyển trực tuyến. Đồng thời, hệ thống hỗ trợ quản trị viên quản lý tài khoản, bài đăng,... Hệ thống được phát triển dựa trên kiến thức môn Phát triển ứng dụng Web và ứng dụng các công cụ HTML, CSS, JavaScript, PHP và MySQL.
...
- **Thành viên:** Người dùng đã đăng ký có thể tạo hồ sơ cá nhân, kết nối và tương tác với người dùng khác, đăng bài chia sẻ, tìm kiếm việc làm và ứng tuyển trực tuyến.
- **Quản trị viên:** Quản lý toàn bộ nội dung và hoạt động của hệ thống (bài đăng, tài khoản,...), kiểm duyệt nội dung, theo dõi mức độ tương tác của người dùng và báo cáo thống kê.
### Mục tiêu
...
- **Quản lý trực quan:** Xây dựng giao diện responsive, thân thiện với người dùng; cung cấp bảng điều khiển giúp quản trị viên dễ dàng quản lý tài khoản, bài đăng, tuyển dụng và cộng đồng.
...
- **Kết nối cộng đồng:** Theo dõi, kết bạn hoặc tham gia các cộng đồng nghề nghiệp theo lĩnh vực quan tâm.
- **Tìm kiếm việc làm & Ứng tuyển:** Tìm kiếm tin tuyển dụng theo vị trí, kỹ năng hoặc công ty; gửi CV và ứng tuyển trực tuyến.
- **Nhắn tin:** Trao đổi và kết nối trực tiếp giữa các người dùng.
### Dành cho Quản trị viên
- **Quản lý tài khoản:** Thêm, chỉnh sửa, khóa hoặc xóa tài khoản người dùng.
- **Quản lý bài đăng:** Kiểm duyệt nội dung bài viết và xử lý vi phạm cộng đồng.
...
3. Tạo cơ sở dữ liệu qua **phpMyAdmin** và import file SQL: database/helios.sql
4. Cấu hình kết nối trong config/Database.php.
5. Chạy ứng dụng bằng cách truy cập: http://localhost/helios

## Hạn chế và hướng phát triển
### Hạn chế
- Chưa tối ưu hệ thống realtime cho lượng lớn người dùng đồng thời.
- Chưa tích hợp AI gợi ý việc làm phù hợp.
### Hướng phát triển
- Phát triển ứng dụng di động Android và iOS.
- Tích hợp AI đề xuất việc làm và kết nối người dùng phù hợp.
- Phát triển hệ thống video meeting.
- Mở rộng nền tảng thành hệ sinh thái tuyển dụng và học tập trực tuyến.
